...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002024569093').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mickey:Dwip555@dwip.ck0hnxc.mongodb.net/?retryWrites=true&w=majority&appName=Dwip")
